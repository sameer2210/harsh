...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onLogout, userEmail }) => {
  return (
    <div className={`
      ...
      <div className="relative flex-1 overflow-y-auto custom-scrollbar flex flex-col">
        ...
        <div className="p-6 pb-2">
            <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                    <h2 className="text-xl font-serif font-bold text-white tracking-wide">Rajesh Verma</h2>
                    <div className="flex items-center space-x-2">
                        <span className="h-2 w-2 bg-green-400 rounded-full"></span>
                        <span className="text-xs text-green-100 uppercase tracking-widest">Active Patient</span>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/10 mb-6">
                 <div className="flex justify-between items-start mb-2">
                    <h3 className="text-sm font-semibold text-green-100 uppercase tracking-wide">Clinical Snapshot</h3>
                    <ICONS.Settings />
                 </div>
                 ...
                 <div className="space-y-4 mt-3">
                    <div className="flex items-center justify-between group cursor-pointer">
                        <div className="flex items-center space-x-3">
                            <div className="p-1.5 bg-yellow-600/30 rounded-lg text-yellow-200"><ICONS.Pulse /></div>
                    ...
                    <div className="flex items-center justify-between group cursor-pointer">
                        <div className="flex items-center space-x-3">
                            <div className="p-1.5 bg-red-600/30 rounded-lg text-red-200"><ICONS.Activity /></div>
                    ...
                    <div className="flex items-center justify-between group cursor-pointer">
                        <div className="flex items-center space-x-3">
                            <div className="p-1.5 bg-orange-600/30 rounded-lg text-orange-200"><ICONS.Temp /></div>
        ...
        <div className="px-6 mb-4">
            <h3 className="text-sm font-semibold text-green-200/80 uppercase tracking-wide mb-3 border-b border-white/10 pb-1">Ayurvedic Assessment</h3>
            <div className="space-y-3">
                <div className="flex items-start space-x-2 text-sm text-gray-200">
                    <ICONS.CheckCircle />
                    <span><strong className="text-white">Digestion:</strong> Acidity & Heartburn</span>
                </div>
                <div className="flex items-start space-x-2 text-sm text-gray-200">
                    <div className="opacity-50"><ICONS.CheckCircle /></div>
                    <span><strong className="text-white">Sleep Pattern:</strong> Disturbed Sleep</span>
                </div>
                <div className="flex items-start space-x-2 text-sm text-gray-200">
                    <div className="text-yellow-400"><ICONS.Pulse /></div>
                    <span><strong className="text-white">Stress Level:</strong> High</span>
                </div>
            </div>
        </div>
        ...
        <div className="px-6 mb-6">
             <div className="flex justify-between items-center mb-2">
                <h3 className="text-sm font-semibold text-green-200/80 uppercase tracking-wide">Current Imbalance</h3>
        ...
        <div className="px-6 flex-1">
            <h3 className="text-sm font-semibold text-green-200/80 uppercase tracking-wide mb-3 border-b border-white/10 pb-1">Doctor-Approved Plan</h3>
        ...
        <div className="p-4 mt-auto">
             <button onClick={onLogout} className="w-full py-2 border border-white/20 rounded-lg text-xs text-white/60 hover:bg-white/10 transition-colors uppercase tracking-widest">
                Exit Session
             </button>
        </div>
      </div>
